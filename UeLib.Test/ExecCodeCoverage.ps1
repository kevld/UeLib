...
reportgenerator -reports:"$dir/TestResults/$cmdGuid/coverage.cobertura.xml" -targetdir:"coveragereport" -reporttypes:Html -historydir:$dir/CoverageHistory -classfilters:"-UeLib.Migrations.*;-UeLib.Data.Models.*EntityTypeConfiguration;-UeLib.Data.UeLibContext;-Program"
